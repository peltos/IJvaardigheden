        ...
        if ($row["role"] == 0) {
            if ($row["schoolGroup_schoolGroup"] == null) {
                ...
                while ($row2 = $result2->fetch_assoc()) {
                    echo '<option value="' . $row2['schoolGroup_schoolGroup'] . '">' . $row2['schoolGroup_schoolGroup'] . "</option>";
                }
                echo '</select>';
                echo '<button class="btn btn-primary btn-block" type="submit" disabled>Submit</button>';
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo $_SESSION['userPicture'] ?>" class="img-circle" alt="Avatar">
                            <span><?php echo $_SESSION['userFName'] . ' ' . $_SESSION['userLName'] ?></span> </a>
